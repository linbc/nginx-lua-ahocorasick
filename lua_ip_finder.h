#ifndef __LUA_IP_FINDER_H_
#define __LUA_IP_FINDER_H_
...
public:   
	...
	unsigned long GetValue4(unsigned long indexStart) const;    // 转换    
	...
	bool IsRightIpString(const char* pszIp) const;    // 输出数据    
